...
function (declare, dojo, TemplatedMixin, ContentPane, domGeometry, Moveable, move) {
	...
	return declare([ContentPane, TemplatedMixin], {
		 ...
		 * - zIndex: the initial zIndex of the Window
		 *
		...
		postCreate: function()
		{
			...
			this.domNode.style.zIndex = this._zIndex;
			...
			this.connect(
				...
				function (evt)
				{
					this.windowNode.style.zIndex = this.windowManager.getZIndex();
				}
			);
		...
		{			
			...
			var parentContentBox = dojo.contentBox(this.domNode.parentNode);
			
			this.windowNode.style.left = parentContentBox.l + "px";
			this.windowNode.style.top = parentContentBox.t + "px";
			this.windowNode.style.height = parentContentBox.h + "px";
			this.windowNode.style.width = parentContentBox.w + "px";
