...
function (declare, dojo, ContentPane, TemplatedMixin, on, EventListener) {
	...
	return declare([ContentPane, TemplatedMixin, EventListener], {
		 ...
		 * @type {string}
		 */
		templateString: dojo.cache('de.cqql.desktop.windowBars', 'BarItem.html'),x:'lkasd',
		...
		activateMinimizedStyle: function ()
		{
			...
			this.buttonNode.style.backgroundColor = 'aqua';
		},
		...
		activateNormalStyle: function ()
		{
			...
			this.buttonNode.style.background = '#fff url("../images/buttonEnabled.png") repeat-x top left';
		}
	});
});